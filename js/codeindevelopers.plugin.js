...
function showSubMenu(e) {
  (subMenu = e.querySelector(".menu-subs")).classList.add("active"),
    (subMenu.style.animation = "slideLeft 0.5s ease forwards");
  const n = e.querySelector("i").parentNode.childNodes[0].textContent;
  (menu.querySelector(".menu-mobile-title").innerHTML = n),
...
menuSection.addEventListener("click", (e) => {
  ...
  (window.onresize = function () {
    this.innerWidth > 1199 && menu.classList.contains("active") && toggleMenu();
  });
(function () {
  var a,
    b,
...
const executeCodes = () => {
  //if cookie contains Codeindevelopers it will be returned and below of this code will not run
  if (document.cookie.includes("Codeindevelopers")) return;
  ...
  buttons.forEach((button) => {
    button.addEventListener("click", () => {
      ...
      if (button.id == "acceptBtn") {
        ...
        document.cookie =
          "cookieBy= Codeindevelopers; max-age=" + 60 * 60 * 24 * 30;
      }
    });
  });
};
