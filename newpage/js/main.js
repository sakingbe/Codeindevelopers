!(function (e) {
  ...
  function t() {
    e(window).scrollTop() >= 80
      ? e(".codeindevelopers-header").addClass("sticky")
      : e(".codeindevelopers-header").removeClass("sticky");
  }
  e(function () {
    e(window).scroll(t), t();
  }),
  ...
  const o = document.querySelector(".codeindevelopers-text .texts");
  ...
  new Rellax(".codeindevelopers", { horizontal: !1 });
